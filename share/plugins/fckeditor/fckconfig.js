...
FCKConfig.DocType = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">' ; //LODEL
...
FCKConfig.DefaultLanguage		= 'fr' ; // LODEL

FCKConfig.ContentLangDirection	= 'ltr' ;

FCKConfig.ProcessHTMLEntities	= false ; // LODEL
...
FCKConfig.IEForceVScroll = false ;//popop
...
FCKConfig.ToolbarSets["Advanced"] = [
        ['NewPage','-','Cut','Copy','Paste','PasteText','PasteWord'],
...
FCKConfig.ToolbarSets["Basic"] = [
        ['Bold','Italic','Underline','-','Link','Unlink','-','About','-','Source']
] ;
FCKConfig.ToolbarSets["Simple"] = [
        ['NewPage','-','Cut','Copy','Paste'],
        ['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript'],
