...
/**
* Fonction qui enleve les tags sp�ifi�
*/
...
/**
 * Fonction qui remplace les guillemets d'un texte par leur name d'entit�(&quot;)
 */
...
/**
 * Retourne le texte si la date est d�ass�, sinon retourne une chaine vide.
 */
...
/**
 * Fonction utilis� ci dessous pour la num�otation des paragraphes
 */
...
/**
 * Filtre de num�otation des paragraphes
 * 
 * Ajoute un <span class="paramnumber"> contenant une ancre avec le num�o du paragraphe
 *
 * @param string $texte le texte �num�ot�pass�par r��ence
 */
function paranumber(&$texte)
{
  static $paranum_count;
	//Regexp : cherche les paragraphes �num�oter, en ignorant les paragraphes contenant une image ou un tableau
