...
/*
    function PMA_mysql_fetch_field($result , $field_offset = FALSE) {
        if ($field_offset != FALSE) {
            return PMA_convert_display_charset($result->fetchField($field_offset));
        } else {
            return PMA_convert_display_charset($result->fetchField());
        }
    }
*/
...
/*
    function PMA_mysql_field_type($result, $field_index) {
        return PMA_convert_display_charset($result->getFieldType($field_index));
    }
*/
