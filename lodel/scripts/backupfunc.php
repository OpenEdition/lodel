...
// liste des tables a sauvegarder lors d'un backup de site (dump de la structure seulement, pas des données)
...
/**
 * Parse un dump MySQL et execute les requ�es.
 *
...
/**
 * Enl�e le pr�ix actuel et ajoute le pr�ixe par d�aut dans une table MySQL
 *
 * Cette fonction est utilis� dans les fonctions PMA
 *
...
/**
 * Importation d'un ME ou de donn�s depuis son archive ZIP
 *
 * @param string $archive le chemin vers le fichier ZIP
 * @param array $accepteddirs la liste des r�ertoires accept� dans l'archive ZIP
 * @param array $acceptedexts la liste des types de fichiers accept�
 * @param string $sqlfile le nom du fichier SQL �traiter. Vide par d�aut
 */
