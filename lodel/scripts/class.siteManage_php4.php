...
class siteManage {
	 ...
	 */
	function siteManage($id, &$context, $reinstall, $maindefault, $singledatabase, $version, $downloadsiteconfig, $mano)
	{
		$this->id = intval($id);
		$this->critere = "id='$id'";
		...
		$this->downloadsiteconfig = $downloadsiteconfig;
		$this->mano = $mano;
	}
	 ...
	 * Accesseur $id
	 *
	 * Cette fonction renvoi la valeur de la variable $id
	 */
	function get_id()
	{
		return $this->id;
	 ...
	 * Accesseur $reinstall
	 *
	 * Cette fonction renvoi la valeur de la variable $reinstall
	 */
	function get_reinstall()
	{
	 ...
	 * Accesseur $critere
	 *
	 * Cette fonction renvoi la valeur de la variable $critere
	 */
	function get_critere()
	{
		return $this->critere;
	}

	/**
	 * Accesseur $maindefault
	 *
	 * Cette fonction renvoi la valeur de la variable $maindefault
	 */
	function get_maindefault()
	{
		return $this->maindefault;
	}

	/**
	 * Accesseur $versiondir
	 *
	 * Cette fonction renvoi la valeur de la variable $versiondir
	 */
	...
	/**
	 * Accesseur $lodelhomere
	 *
	 * Cette fonction renvoi la valeur de la variable $lodelhomere
	 */
	function get_lodelhomere()
	{
		return $this->lodelhomere;
	}

	/**
	 * Accesseur $singledatabase
	 *
	 * Cette fonction renvoi la valeur de la variable $singledatabase
	 */
	function get_singledatabase()
	{
	 ...
	 * Accesseur $database
	 *
	 * Cette fonction alloue la valeur $db à la variable $database
	 */
