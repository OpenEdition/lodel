...
require_once 'cache/arithmetic.php';
require_once 'cache/tagging.php';
require_once 'cache/garbagecollect.php';
...
abstract class Cache {
	 ...
	 */
	public static function instance($group, $config)
	{
		...
		require_once "cache/{$config['driver']}.php";
