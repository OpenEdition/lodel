...
$result=mysql_query ("SELECT * FROM $GLOBALS[tableprefix]typepersonnes WHERE nom='$type' AND status>0") or die (mysql_error());
$context=array_merge_withprefix($context,"type_",mysql_fetch_assoc($result));
$context[idtype]=$context[type_id]; // import
$context[type_tri]=$GLOBALS[tableprefix]."personnes.".$context[type_tri];  // prefix par la table... ca aide
