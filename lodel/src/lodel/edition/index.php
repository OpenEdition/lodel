...
if ($id) {
  do {
    $result=mysql_query ("SELECT tpledition,idparent FROM $GLOBALS[entitestypesjoin] WHERE $GLOBALS[tp]entites.id='$id' AND $GLOBALS[tp]types.classe='publications'") or die (mysql_error());
