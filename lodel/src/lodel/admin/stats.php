...
$result=mysql_query("SELECT COUNT(*) FROM $GLOBALS[tp]documents") or die (mysql_error());
...
$result=mysql_query("SELECT COUNT(*) FROM $GLOBALS[tp]typedocs") or die (mysql_error());
