...
$result=mysql_query("SELECT COUNT(*) FROM $GLOBALS[tp]documents") or die($db->errormsg());
...
$result=mysql_query("SELECT COUNT(*) FROM $GLOBALS[tp]documents WHERE status<-1") or die($db->errormsg());
...
$result=mysql_query("SELECT COUNT(*) FROM $GLOBALS[tp]documents WHERE status>-32 AND status<0") or die($db->errormsg());
...
$result=mysql_query("SELECT COUNT(*) FROM $GLOBALS[tp]documents WHERE status>0") or die($db->errormsg());
...
$result=mysql_query("SELECT COUNT(*) FROM $GLOBALS[tp]publications") or die($db->errormsg());
...
$result=mysql_query("SELECT COUNT(*) FROM $GLOBALS[tp]publications WHERE status<-1") or die($db->errormsg());
...
$result=mysql_query("SELECT COUNT(*) FROM $GLOBALS[tp]publications WHERE status>-32 AND status<0") or die($db->errormsg());
...
$result=mysql_query("SELECT COUNT(*) FROM $GLOBALS[tp]publications WHERE status>0 AND status<32") or die($db->errormsg());
...
$result=mysql_query("SELECT COUNT(*) FROM $GLOBALS[tp]typedocs") or die($db->errormsg());
...
{
	$result=mysql_query("SELECT type AS nomtypedoc, COUNT(type) AS nbtypedoc FROM $GLOBALS[tp]documents GROUP BY type") or die($db->errormsg());
...
$result=mysql_query("SELECT COUNT(*) FROM $GLOBALS[tp]typepublis") or die($db->errormsg());
...
# ghi #### derniere remarque, nom_occ_type_publi ... nombre_occurence_type_publi est pas bcp plus long, et bcp plus claire.
	$result=mysql_query("SELECT type AS nomtypepubli, COUNT(type) AS nbtypepubli FROM $GLOBALS[tp]publications GROUP BY type") or die($db->errormsg());
	while($row=mysql_fetch_array($result,MYSQL_ASSOC))
	{
